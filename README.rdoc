...
...can be downloaded at <a href="http://clojars.org/repo/mmemail/mmemail/1.0.0/mmemail-1.0.0.jar">http://clojars.org/repo/mmemail/mmemail/1.0.0/mmemail-1.0.0.jar</a>
...
The <code>create-mailer</code> accepts email parameters that will be used as defaults when the generated function is called.
    ...
    (def my_mailer (create-mailer {:subject "Greetings" :body "Meep Meep!" :host "smtp.gmail.com" :port 465 :ssl true :user "road@gmail.com" :password "runner"}))
